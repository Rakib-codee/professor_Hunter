...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'text-[20px] leading-snug font-semibold group-data-[size=sm]/card:text-base',
        className,
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'bg-muted flex items-center rounded-b-sm border-t p-(--card-spacing)',
        className,
      )}
      {...props}
    />
